...
class SensorAdapterManager(object):
    """
    Manages the sensor adapters and telemetry generation.
    """
    ...
    def handleTelemetry(self):
        if self.humidityAdapter and self.pressureAdapter and self.tempAdapter:
            ...
            logging.warning("One or more sensor adapters are not initialized.")
    ...
    def stopManager(self):
        ...
        try:
            ...
            logging.info("SensorAdapterManager scheduler already stopped. Ignoring. Error: " + str(e))
            return False
